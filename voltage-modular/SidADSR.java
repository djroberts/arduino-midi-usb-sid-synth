...
public class SidADSR extends VoltageModule
//[user-inheritance]
//[/user-inheritance]
{

   public SidADSR( long moduleID, VoltageObjects voltageObjects )
   {
      super( moduleID, voltageObjects, "SidADSR", ModuleType.ModuleType_Utility, 1.4 );
...
void InitializeControls()
{
      ...
      pwENV.SetPosition( 12, 188 );
      pwENV.SetSize( 27, 27 );
      pwENV.SetSkin( "Plastic White" );
      pwENV.SetRange( -63, 63, 0, false, 128 );
      ...
      decay = new VoltageKnob( "decay", "decay", this, 0.0, 127, 0 );
      AddComponent( decay );
      decay.SetWantsMouseNotifications( false );
      decay.SetPosition( 56, 39 );
      decay.SetSize( 27, 27 );
      decay.SetSkin( "Plastic White" );
      decay.SetRange( 0.0, 127, 0, false, 128 );
      decay.SetKnobParams( 215, 145 );
      decay.DisplayValueInPercent( false );
      decay.SetKnobAdjustsRing( true );

      sustain = new VoltageKnob( "sustain", "sustain", this, 0.0, 127, 0 );
      AddComponent( sustain );
      sustain.SetWantsMouseNotifications( false );
      sustain.SetPosition( 12, 103 );
      sustain.SetSize( 27, 27 );
      sustain.SetSkin( "Plastic White" );
      sustain.SetRange( 0.0, 127, 0, false, 128 );
      sustain.SetKnobParams( 215, 145 );
      sustain.DisplayValueInPercent( false );
      sustain.SetKnobAdjustsRing( true );

      release = new VoltageKnob( "release", "release", this, 0.0, 127, 0 );
      AddComponent( release );
      release.SetWantsMouseNotifications( false );
      release.SetPosition( 55, 99 );
      release.SetSize( 27, 27 );
      release.SetSkin( "Plastic White" );
      release.SetRange( 0.0, 127, 0, false, 128 );
      release.SetKnobParams( 215, 145 );
      release.DisplayValueInPercent( false );
      release.SetKnobAdjustsRing( true );

      textLabel4 = new VoltageLabel( "textLabel4", "textLabel4", this, "Sustain" );
      AddComponent( textLabel4 );
      textLabel4.SetWantsMouseNotifications( false );
      textLabel4.SetPosition( 0, 130 );
      textLabel4.SetSize( 44, 30 );
      ...
      textLabel5 = new VoltageLabel( "textLabel5", "textLabel5", this, "Release" );
      AddComponent( textLabel5 );
      textLabel5.SetWantsMouseNotifications( false );
      textLabel5.SetPosition( 47, 131 );
      textLabel5.SetSize( 44, 30 );
      ...
      textLabel2.SetPosition( 0, 68 );
      textLabel2.SetSize( 44, 30 );
      ...
      textLabel6 = new VoltageLabel( "textLabel6", "textLabel6", this, "PW" );
      AddComponent( textLabel6 );
      textLabel6.SetWantsMouseNotifications( false );
      textLabel6.SetPosition( 0, 214 );
      textLabel6.SetSize( 44, 30 );
      ...
      textLabel3 = new VoltageLabel( "textLabel3", "textLabel3", this, "Decay" );
      AddComponent( textLabel3 );
      textLabel3.SetWantsMouseNotifications( false );
      textLabel3.SetPosition( 44, 68 );
      ...
      textLabel7 = new VoltageLabel( "textLabel7", "textLabel7", this, "Pitch" );
      AddComponent( textLabel7 );
      textLabel7.SetWantsMouseNotifications( false );
      textLabel7.SetPosition( 45, 216 );
      textLabel7.SetSize( 44, 30 );
      ...
      textLabel8 = new VoltageLabel( "textLabel8", "textLabel8", this, "Envelope" );
      AddComponent( textLabel8 );
      textLabel8.SetWantsMouseNotifications( false );
      textLabel8.SetPosition( 21, 154 );
      textLabel8.SetSize( 44, 30 );
   ...
   private VoltageKnob release;
   private VoltageKnob sustain;
   private VoltageKnob decay;
   ...
   private void sendPitch() {
      sendCCMessage(SidConstants.CC_PITCH_ADSR_ATTACK, (int)attack.GetValue());
      sendCCMessage(SidConstants.CC_PITCH_ADSR_DECAY, (int)decay.GetValue());
      sendCCMessage(SidConstants.CC_PITCH_ADSR_SUSTAIN, (int)sustain.GetValue());
      sendCCMessage(SidConstants.CC_PITCH_ADSR_RELEASE, (int)release.GetValue());
      sendCCMessage(SidConstants.CC_PITCH_ADSR_ENV, (int)(pitchENV.GetValue() + 63.0));

   }

   private void sendPW() {
      sendCCMessage(SidConstants.CC_PW_ADSR_ATTACK, (int)attack.GetValue());
      sendCCMessage(SidConstants.CC_PW_ADSR_DECAY, (int)decay.GetValue());
      sendCCMessage(SidConstants.CC_PW_ADSR_SUSTAIN, (int)sustain.GetValue());
